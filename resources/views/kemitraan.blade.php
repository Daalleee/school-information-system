...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="/kemitraan" class="text-blue-600 font-medium">Kemitraan</a>
    ...
    <section class="pt-16">
        <div
            class="relative bg-gradient-to-br from-purple-600 via-purple-700 to-purple-900 text-white overflow-hidden">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="text-xl text-purple-100 max-w-3xl mx-auto">Membangun jaringan kerjasama untuk
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">Program Kemitraan</h2>
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">Berbagai bentuk kerjasama yang kami bangun untuk
                    kemajuan pendidikan</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8">
                <div
                    class="bg-gradient-to-br from-purple-50 to-white rounded-xl p-8 border border-purple-100 hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Kemitraan Akademik</h3>
                    <p class="text-gray-600">Kerjasama dengan universitas dan institusi pendidikan untuk pengembangan
                        kurikulum, pelatihan guru, dan program magang siswa.</p>
                </div>

                <div
                    class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-8 border border-blue-100 hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Kemitraan Industri</h3>
                    <p class="text-gray-600">Kerjasama dengan perusahaan dan organisasi untuk program beasiswa,
                        kunjungan industri, dan penempatan karir bagi lulusan.</p>
                </div>

                <div
                    class="bg-gradient-to-br from-green-50 to-white rounded-xl p-8 border border-green-100 hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Kemitraan Komunitas</h3>
                    <p class="text-gray-600">Kerjasama dengan organisasi masyarakat, gereja, dan LSM untuk program
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">Mitra Kami</h2>
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">Institusi dan organisasi yang telah bekerjasama
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition duration-300">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 class="font-bold text-gray-800 mb-1">Universitas Flores</h3>
                    <p class="text-sm text-gray-500">Kemitraan Akademik</p>
                </div>

                <!-- Mitra 2 -->
                <div class="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition duration-300">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-green-100 to-green-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 class="font-bold text-gray-800 mb-1">UNDANA Kupang</h3>
                    <p class="text-sm text-gray-500">Kemitraan Akademik</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition duration-300">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-purple-100 to-purple-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 class="font-bold text-gray-800 mb-1">Yayasan SVD</h3>
                    <p class="text-sm text-gray-500">Pemilik Yayasan</p>
                </div>

                <!-- Mitra 4 -->
                <div class="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition duration-300">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-orange-100 to-orange-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 class="font-bold text-gray-800 mb-1">Dinas Pendidikan NTT</h3>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition duration-300">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-red-100 to-red-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 class="font-bold text-gray-800 mb-1">Karitas Ende</h3>
                    <p class="text-sm text-gray-500">Organisasi Sosial</p>
                </div>

                <!-- Mitra 6 -->
                <div class="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition duration-300">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-teal-100 to-teal-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 class="font-bold text-gray-800 mb-1">Perpustakaan Daerah</h3>
                    <p class="text-sm text-gray-500">Kemitraan Literasi</p>
                </div>

                <!-- Mitra 7 -->
                <div class="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition duration-300">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-indigo-100 to-indigo-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 class="font-bold text-gray-800 mb-1">Alumni Syuradikara</h3>
                    <p class="text-sm text-gray-500">Ikatan Alumni</p>
                </div>

                <!-- Mitra 8 -->
                <div class="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition duration-300">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 class="font-bold text-gray-800 mb-1">Paroki Ende</h3>
                    <p class="text-sm text-gray-500">Kemitraan Pastoral</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">Ajukan Kerjasama</h2>
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">Tertarik untuk bermitra dengan SMAK Syuradikara? Isi
            ...
            <div class="max-w-3xl mx-auto">
                <div class="bg-gray-50 rounded-2xl p-8 md:p-12 shadow-sm">
                    <form class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Subjek Kerjasama</label>
                            <input type="text"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                placeholder="Ringkasan proposal kerjasama">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Detail Kerjasama</label>
                            <textarea rows="5"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                placeholder="Jelaskan secara singkat bentuk kerjasama yang diusulkan..."></textarea>
                        </div>
                        <button type="submit"
                            class="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-4 rounded-lg transition duration-200">Kirim
