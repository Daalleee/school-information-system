        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="/kontak" class="text-yellow-600 font-medium">Kontak</a>
                </div>
        ...
        <div
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="text-xl text-black max-w-3xl mx-auto">Kami siap membantu Anda. Jangan ragu untuk
                        menghubungi kami</p>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-1">
                    <div class="bg-white rounded-xl shadow-md p-8 h-full">
                        <h3 class="text-2xl font-bold text-black mb-6">Informasi Kontak</h3>
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-bold text-black mb-1">Alamat</p>
                                    <p class="text-black text-sm">Jl. Wirajaya, Kel. Onekore, Kec. Ende Tengah,
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-bold text-black mb-1">Telepon / Fax</p>
                                    <p class="text-black text-sm">(0381) 21648</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-bold text-black mb-1">Email</p>
                                    <p class="text-black text-sm">smakswastasyuradikara@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-bold text-black mb-1">Jam Operasional</p>
                                    <p class="text-black text-sm">Senin - Jumat: 07:00 - 15:00<br>Sabtu: 07:00 -
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            <h4 class="font-bold text-black mb-4">Ikuti Kami</h4>
                            <div class="flex space-x-3">
                                <a href="#"
                                    class="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center text-white hover:bg-yellow-500 transition">
                                ...
                                <a href="#"
                                    class="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center text-white hover:opacity-90 transition">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                ...
                <div class="md:col-span-2">
                    <div class="bg-white rounded-xl shadow-md p-8">
                        ...
                        <form class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-black mb-2">Subjek <span
                                        class="text-black">*</span></label>
                                <input type="text" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-black mb-2">Pesan <span
                                        class="text-black">*</span></label>
    ...
    <section class="py-8 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="p-6">
                    <h3 class="text-xl font-bold text-black mb-4">Lokasi Sekolah</h3>
                </div>
                <div
                    class="h-96 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center relative">
                    <div class="text-center">
                        <svg class="w-16 h-16 text-black mx-auto mb-4" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z">
                            </path>
                        ...
                        <p class="text-black font-medium">Peta Lokasi SMAK Syuradikara</p>
                        <p class="text-black text-sm mt-1">Jl. Wirajaya, Ende, NTT, Indonesia</p>
                        <a href="https://maps.google.com/?q=SMAK+Syuradikara+Ende" target="_blank"
                            class="inline-block mt-4 bg-yellow-400 text-white text-sm font-medium py-2 px-6 rounded-lg hover:bg-yellow-500 transition">Buka
                            di Google Maps</a>
                    </div>
                </div>
            </div>
