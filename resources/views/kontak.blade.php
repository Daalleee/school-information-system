        ...
        <div
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="text-xl text-yellow-100 max-w-3xl mx-auto">Kami siap membantu Anda. Jangan ragu untuk
                        menghubungi kami</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-8 h-full">
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <div class="flex space-x-3">
                                ...
                                <a href="#"
                                    class="w-10 h-10 bg-gradient-to-br from-yellow-400 to-pink-500 rounded-full flex items-center justify-center text-white hover:opacity-90 transition">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path
