...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-black mt-1">Kelola foto dan galeri sekolah</p>
        </div>
        ...
        <form method="GET" action="{{ route('admin.galeri.index') }}" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2">
                    <label for="search" class="block text-sm font-medium text-black mb-1">Cari Foto</label>
                    <div class="relative">
        ...
        @forelse($galeris as $galeri)
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="relative h-48 bg-white">
                    ...
                    <div class="absolute inset-0 items-center justify-center hidden bg-white">
                    ...
                    @if($galeri->kategori)
                        <div class="absolute top-3 left-3">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-yellow-400 text-white bg-opacity-90">
                                {{ $galeri->kategori }}
                            </span>
                        </div>
                    @endif
                ...
                <div class="p-4">
                    ...
                    <p class="text-xs text-black mb-3">{{ $galeri->created_at->format('d M Y') }}</p>

                    <!-- Actions -->
                    <div class="flex items-center justify-between gap-2">
                        <a href="{{ route('admin.galeri.edit', $galeri) }}"
                            class="flex-1 inline-flex items-center justify-center px-3 py-2 bg-yellow-400 hover:bg-yellow-500 text-white text-xs font-medium rounded-lg shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2">
                        ...
                        <form method="POST" action="{{ route('admin.galeri.destroy', $galeri) }}"
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="inline-flex items-center justify-center px-3 py-2 bg-black hover:bg-yellow-500 hover:text-black text-white text-xs font-medium rounded-lg shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2">
        ...
        @empty
            ...
            <div class="col-span-full">
                <div class="bg-white rounded-xl shadow-md p-12 text-center">
                    ...
                    <p class="mt-2 text-sm text-black">Mulai dengan menambahkan foto baru ke galeri.</p>
                    <div class="mt-6">
                        <a href="{{ route('admin.galeri.create') }}"
