...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-black mt-1">Isi form di bawah untuk menambahkan foto baru</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.galeri.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                <label class="block text-sm font-semibold text-black mb-2">
                    Gambar <span class="text-black">*</span>
                </label>
            ...
            <div>
                ...
                <p class="mt-2 text-xs text-black">Kategori digunakan untuk mengelompokkan foto galeri.</p>
                @error('kategori')
                    <p class="mt-2 text-sm text-black flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
