...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Perbarui informasi foto galeri</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.galeri.update', $galeri) }}" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">
                    Gambar <span class="text-gray-400 font-normal">(opsional)</span>
                </label>
                <div class="flex items-start space-x-6">
                    <div class="flex-shrink-0">
                        <div id="gambarPreview" class="h-48 w-64 rounded-lg bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden">
                            ...
                            @else
                                <svg id="previewPlaceholder" class="w-16 h-16 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="gambar"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    @if($galeri->gambar)
                                        <p class="mt-2 text-xs text-blue-600">Gambar saat ini akan diganti jika upload baru.</p>
                                    @endif
                                </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <h3 class="text-sm font-semibold text-gray-700 mb-3">Informasi Foto</h3>
