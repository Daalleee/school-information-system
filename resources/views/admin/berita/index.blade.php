...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Kelola semua berita dan artikel sekolah</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($beritas as $berita)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-600">{{ $berita->user->name ?? '-' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
        ...
        <div class="md:hidden divide-y divide-gray-200">
            @forelse($beritas as $berita)
                <div class="p-4 space-y-3">
                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                        <p class="text-xs text-gray-500">Penulis: {{ $berita->user->name ?? '-' }}</p>
            ...
            @empty
                <div class="p-8 text-center">
                    <p class="text-sm text-gray-500">Tidak ada data berita.</p>
                </div>
            @endforelse
        </div>
