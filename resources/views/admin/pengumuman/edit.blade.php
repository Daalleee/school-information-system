...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-black mt-1">Perbarui informasi pengumuman</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.pengumuman.update', $pengumuman) }}" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="isi" id="isi" rows="10" required
                    ...
                    class="block w-full rounded-lg border @error('isi') border-yellow-400 @else border-gray-300 @enderror focus:ring-yellow-400 focus:border-yellow-400 shadow-sm py-2.5 text-sm @error('isi') ring-2 ring-yellow-200 @enderror">{{ old('isi', $pengumuman->isi) }}</textarea>
                @error('isi')
                    <p class="mt-2 text-sm text-black flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
            ...
            <div class="bg-white rounded-lg p-4 border border-gray-200">
                <h3 class="text-sm font-semibold text-black mb-3">Informasi Pengumuman</h3>
