...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Kelola semua pengumuman sekolah</p>
        </div>
                    ...
                    @forelse($pengumumans as $index => $pengumuman)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500">{{ $pengumumans->firstItem() + $index }}</div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900 line-clamp-2">{{ $pengumuman->judul }}</div>
                                <div class="text-sm text-gray-500 line-clamp-1 mt-1">{{ Str::limit($pengumuman->isi, 100) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-600">{{ $pengumuman->tanggal->format('d M Y') }}</div>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan pengumuman baru.</p>
                                <div class="mt-6">
                                    <a href="{{ route('admin.pengumuman.create') }}"
        ...
        <div class="md:hidden divide-y divide-gray-200">
            @forelse($pengumumans as $pengumuman)
                <div class="p-4 space-y-3">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">{{ $pengumuman->tanggal->format('d M Y') }}</p>
                    </div>
            ...
            @empty
                <div class="p-8 text-center">
                    <p class="text-sm text-gray-500">Tidak ada data pengumuman.</p>
                </div>
            @endforelse
        </div>
