...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Kelola informasi profil sekolah</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <form method="POST" action="{{ route('admin.profil.update') }}" enctype="multipart/form-data" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="nama_sekolah" id="nama_sekolah"
                                    ...
                                    class="pl-10 block w-full rounded-lg border @error('nama_sekolah') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('nama_sekolah') ring-2 ring-red-200 @enderror">
                            </div>
                            @error('nama_sekolah')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="alamat" id="alamat" rows="3" required
                                    ...
                                    class="pl-10 block w-full rounded-lg border @error('alamat') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('alamat') ring-2 ring-red-200 @enderror">{{ old('alamat', $profil->alamat) }}</textarea>
                            </div>
                            @error('alamat')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="telepon" id="telepon"
                                    ...
                                    class="pl-10 block w-full rounded-lg border @error('telepon') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('telepon') ring-2 ring-red-200 @enderror">
                            </div>
                            @error('telepon')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                Logo Sekolah <span class="text-gray-400 font-normal">(opsional)</span>
                            </label>
                            <div class="flex items-start space-x-6">
                                <div class="flex-shrink-0">
                                    <div id="logoPreview" class="h-32 w-32 rounded-lg bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden">
                                        @if($profil->logo)
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="logo"
                                            ...
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                ...
                                                @if($profil->logo)
                                                    <p class="mt-2 text-xs text-blue-600">Logo saat ini akan diganti jika upload baru.</p>
                                                @endif
                                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4" required
                                    ...
                                    class="pl-10 block w-full rounded-lg border @error('deskripsi') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('deskripsi') ring-2 ring-red-200 @enderror">{{ old('deskripsi', $profil->deskripsi) }}</textarea>
                            </div>
                            @error('deskripsi')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="visi" id="visi" rows="4" required
                                    ...
                                    class="pl-10 block w-full rounded-lg border @error('visi') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('visi') ring-2 ring-red-200 @enderror">{{ old('visi', $profil->visi) }}</textarea>
                            </div>
                            @error('visi')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="misi" id="misi" rows="5" required
                                    ...
                                    class="pl-10 block w-full rounded-lg border @error('misi') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('misi') ring-2 ring-red-200 @enderror">{{ old('misi', $profil->misi) }}</textarea>
                            </div>
                            @error('misi')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <h3 class="text-sm font-semibold text-gray-700 mb-3">Informasi Profil</h3>
