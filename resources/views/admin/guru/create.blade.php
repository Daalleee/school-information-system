...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Tambah Guru Baru</h1>
            <p class="text-gray-600 mt-1">Isi form di bawah untuk menambahkan data guru</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <form method="POST" action="{{ route('admin.guru.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nip" id="nip" value="{{ old('nip') }}"
                        ...
                        class="pl-10 block w-full rounded-lg border @error('nip') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('nip') ring-2 ring-red-200 @enderror">
                </div>
                @error('nip')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="mata_pelajaran" id="mata_pelajaran" value="{{ old('mata_pelajaran') }}" required
                        ...
                        class="pl-10 block w-full rounded-lg border @error('mata_pelajaran') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('mata_pelajaran') ring-2 ring-red-200 @enderror">
                </div>
