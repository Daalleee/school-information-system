...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-black mt-1">Perbarui informasi pengguna</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="p-6 space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required
                        ...
                        class="pl-10 block w-full rounded-lg border @error('name') border-yellow-400 @else border-gray-300 @enderror focus:ring-yellow-400 focus:border-yellow-400 shadow-sm py-2.5 text-sm @error('name') ring-2 ring-yellow-200 @enderror">
                </div>
                @error('name')
            ...
            <div>
                <label for="email" class="block text-sm font-semibold text-black mb-2">
                    Alamat Email <span class="text-black">*</span>
                </label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                <label for="password" class="block text-sm font-semibold text-black mb-2">
                    Password Baru <span class="text-white font-normal">(opsional)</span>
                </label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <input type="password" name="password" id="password"
                        ...
                        class="pl-10 block w-full rounded-lg border @error('password') border-yellow-400 @else border-gray-300 @enderror focus:ring-yellow-400 focus:border-yellow-400 shadow-sm py-2.5 text-sm @error('password') ring-2 ring-yellow-200 @enderror">
                    <button type="button" onclick="togglePassword('password', this)"
                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-white hover:text-black">
                ...
                <p class="mt-2 text-xs text-black">Kosongkan jika tidak ingin mengubah password. Minimal 8 karakter jika diisi.</p>
                @error('password')
                    <p class="mt-2 text-sm text-black flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation"
                        ...
                        class="pl-10 block w-full rounded-lg border border-gray-300 focus:ring-yellow-400 focus:border-yellow-400 shadow-sm py-2.5 text-sm">
                </div>
            </div>
            ...
            <div>
                <label for="role" class="block text-sm font-semibold text-black mb-2">
                    Role <span class="text-black">*</span>
                </label>
                <div class="relative">
                    <select name="role" id="role" required
                        class="block w-full rounded-lg border @error('role') border-yellow-400 @else border-gray-300 @enderror focus:ring-yellow-400 focus:border-yellow-400 shadow-sm py-2.5 text-sm @error('role') ring-2 ring-yellow-200 @enderror">
            ...
            <div class="bg-white rounded-lg p-4 border border-gray-200">
                <h3 class="text-sm font-semibold text-black mb-3">Informasi User</h3>
