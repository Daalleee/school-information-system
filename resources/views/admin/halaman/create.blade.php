...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Buat halaman statis baru untuk website sekolah</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.halaman.store') }}" class="p-6 space-y-6">
            ...
            <div>
                <label for="slug" class="block text-sm font-semibold text-gray-700 mb-2">
                    Slug <span class="text-gray-400 font-normal">(opsional - akan di-generate otomatis jika kosong)</span>
                </label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <textarea name="konten" id="konten" rows="16" required
                    ...
                    class="block w-full rounded-lg border @error('konten') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('konten') ring-2 ring-red-200 @enderror">{{ old('konten') }}</textarea>
                @error('konten')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
