        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6">
                <div class="space-y-5">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-start gap-2 pb-4 border-b border-gray-100">
                        <div class="sm:w-48 flex-shrink-0">
                            <span class="text-sm font-medium text-gray-500">Asal Sekolah</span>
                        </div>
                        <div class="flex-1">
                ...
                <div class="mt-8 pt-6 border-t border-gray-200 bg-gray-50 rounded-lg p-4">
                    <h3 class="text-sm font-semibold text-gray-700 mb-3">Informasi Pendaftaran</h3>
                    ...
                    <form method="POST" action="{{ route('admin.ppdb.update-status', $ppdb) }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                class="block w-full rounded-lg border @error('status') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('status') ring-2 ring-red-200 @enderror">
                        ...
                        <button type="submit"
                            class="w-full inline-flex items-center justify-center px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
