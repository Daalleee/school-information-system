...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Isi form di bawah untuk menambahkan data siswa</p>
        </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="alamat" id="alamat" rows="3"
                        ...
                        class="pl-10 block w-full rounded-lg border @error('alamat') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('alamat') ring-2 ring-red-200 @enderror">{{ old('alamat') }}</textarea>
                </div>
                @error('alamat')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
