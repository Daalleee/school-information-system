...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Perbarui informasi siswa</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <form method="POST" action="{{ route('admin.siswa.update', $siswa) }}" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $siswa->nama) }}" required
                        ...
                        class="pl-10 block w-full rounded-lg border @error('nama') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('nama') ring-2 ring-red-200 @enderror">
                </div>
                @error('nama')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nis" id="nis" value="{{ old('nis', $siswa->nis) }}"
                        ...
                        class="pl-10 block w-full rounded-lg border @error('nis') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('nis') ring-2 ring-red-200 @enderror">
                </div>
                @error('nis')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="jenis_kelamin" value="P"
                            ...
                            class="form-radio h-4 w-4 text-pink-600 border-gray-300 focus:ring-pink-500">
                        <span class="ml-2 text-sm text-gray-700">
                            <svg class="w-5 h-5 inline-block mr-1 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v16m8-8H4" />
                            </svg>
                            Perempuan
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="kelas" id="kelas" value="{{ old('kelas', $siswa->kelas) }}" required
                        ...
                        class="pl-10 block w-full rounded-lg border @error('kelas') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('kelas') ring-2 ring-red-200 @enderror">
                </div>
                @error('kelas')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="alamat" id="alamat" rows="3"
                        ...
                        class="pl-10 block w-full rounded-lg border @error('alamat') border-red-500 @else border-gray-300 @enderror focus:ring-blue-500 focus:border-blue-500 shadow-sm py-2.5 text-sm @error('alamat') ring-2 ring-red-200 @enderror">{{ old('alamat', $siswa->alamat) }}</textarea>
                </div>
                @error('alamat')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">
                    Foto <span class="text-gray-400 font-normal">(opsional)</span>
                </label>
                <div class="flex items-start space-x-6">
                    <div class="flex-shrink-0">
                        <div id="fotoPreview" class="h-32 w-32 rounded-lg bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden">
                            @if($siswa->foto)
                                <img id="previewImg" src="{{ asset('storage/' . $siswa->foto) }}" alt="Foto {{ $siswa->nama }}"
            ...
            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <h3 class="text-sm font-semibold text-gray-700 mb-3">Informasi Siswa</h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div>
                        <span class="text-gray-500">Dibuat pada:</span>
                        <span class="ml-2 text-gray-900 font-medium">{{ $siswa->created_at->format('d M Y, H:i') }}</span>
                    </div>
                    <div>
                        <span class="text-gray-500">Terakhir diperbarui:</span>
                        <span class="ml-2 text-gray-900 font-medium">{{ $siswa->updated_at->format('d M Y, H:i') }}</span>
                    </div>
                </div>
            </div>
