...
<body class="bg-white">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="/guru" class="text-black hover:text-yellow-600 transition font-medium">Guru &
                        Pegawai</a>
                    <a href="/fasilitas" class="text-yellow-600 font-medium">Fasilitas</a>
                    <div class="relative dropdown">
                        <button onclick="toggleDropdown(this)"
                    ...
                    <a href="/kemitraan"
                        class="text-black hover:text-yellow-600 transition font-medium">Kemitraan</a>
        ...
        <div
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="text-xl text-black max-w-3xl mx-auto">Sarana dan prasarana lengkap untuk mendukung
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center py-20">
                <svg class="w-24 h-24 mx-auto text-black mb-4" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                    </path>
                </svg>
                <h3 class="text-2xl font-bold text-black mb-2">Fasilitas Sekolah</h3>
                <p class="text-black text-lg">Informasi fasilitas akan segera tersedia.</p>
                <p class="text-black text-sm mt-2">Data fasilitas akan dikelola melalui panel admin.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-yellow-400 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-black text-lg mb-8 max-w-2xl mx-auto">Kunjungi sekolah kami dan rasakan langsung
                fasilitas yang tersedia</p>
            <div class="flex flex-wrap gap-4 justify-center">
                <a href="/kontak"
                    class="inline-block bg-yellow-400 text-black font-medium py-3 px-8 rounded-lg hover:bg-yellow-500 transition duration-200">Jadwalkan
                    Kunjungan</a>
                <a href="/ppdb"
                    class="inline-block bg-yellow-400 text-black font-medium py-3 px-8 rounded-lg hover:bg-yellow-500 transition duration-200 border-2 border-white">Daftar
                    PPDB</a>
            </div>
        </div>
    </section>
