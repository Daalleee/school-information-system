...
<head>
    ...
    <title>Galeri SMAK Syuradikara</title>
        ...
        <div class="relative bg-gradient-to-br bg-yellow-400 text-white overflow-hidden">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="text-xl text-black max-w-3xl mx-auto">Momen-momen berharga dari berbagai kegiatan SMAK
                        Syuradikara</p>
                </div>
            </div>
        </div>
    ...
    <section class="py-8 bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap gap-3">
                ...
                <button
                    class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Kegiatan
                    Belajar</button>
                <button
                    class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Upacara</button>
                <button
                    class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Olahraga</button>
                <button
                    class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Seni
                    & Budaya</button>
                <button
                    class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Fasilitas</button>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" id="galleryGrid">
                ...
                @empty
                    <p class="text-center text-black col-span-4">Belum ada foto</p>
                @endforelse
            </div>
