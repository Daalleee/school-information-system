...
<body class="bg-white">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div
                        ...
                        O</div>
                    <div>
                        <h1 class="text-lg font-bold text-black">SMAK Syuradikara - Operator</h1>
                        <p class="text-xs text-black">Dashboard Operator</p>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Welcome Card -->
        <div class="bg-gradient-to-r bg-yellow-400 rounded-2xl shadow-lg p-8 text-white mb-8">
            <h2 class="text-3xl font-bold mb-2">Selamat Datang, {{ auth()->user()->name }}!</h2>
            <p class="text-black">Dashboard Operator - SMAK Syuradikara Ende</p>
        </div>

        <!-- Stats -->
        <div class="grid md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-xl shadow p-6">
                <div class="text-black text-sm mb-2">Total Siswa</div>
                <div class="text-3xl font-bold text-black">-</div>
            </div>
            <div class="bg-white rounded-xl shadow p-6">
                <div class="text-black text-sm mb-2">PPDB Pending</div>
                <div class="text-3xl font-bold text-yellow-600">-</div>
            </div>
            <div class="bg-white rounded-xl shadow p-6">
                <div class="text-black text-sm mb-2">Total Kelas</div>
                <div class="text-3xl font-bold text-black">-</div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-8">
            <h3 class="text-2xl font-bold text-black mb-6">Menu Operator</h3>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <a href="{{ route('operator.ppdb.index') }}"
                    ...
                    <h4 class="text-lg font-bold text-black mb-2">📋 Kelola PPDB</h4>
                    <p class="text-black text-sm">Verifikasi dan update status pendaftar</p>
                </a>

                <a href="#"
                    class="bg-yellow-100 hover:bg-yellow-100 border-2 border-yellow-400 rounded-xl p-6 transition">
                    <h4 class="text-lg font-bold text-black mb-2">👨‍🎓 Data Siswa</h4>
                    <p class="text-black text-sm">Input dan kelola data siswa</p>
                </a>

                <a href="#"
                    class="bg-yellow-100 hover:bg-yellow-100 border-2 border-yellow-400 rounded-xl p-6 transition">
                    <h4 class="text-lg font-bold text-black mb-2">📊 Laporan</h4>
                    <p class="text-black text-sm">Generate laporan sekolah (akan datang)</p>
                </a>

                <a href="#"
                    class="bg-yellow-100 hover:bg-yellow-100 border-2 border-yellow-400 rounded-xl p-6 transition">
                    <h4 class="text-lg font-bold text-black mb-2">📄 Administrasi</h4>
                    <p class="text-black text-sm">Kelola administrasi sekolah (akan datang)</p>
                </a>

                <a href="#"
                    class="bg-yellow-100 hover:bg-yellow-100 border-2 border-yellow-400 rounded-xl p-6 transition">
                    <h4 class="text-lg font-bold text-black mb-2">📅 Jadwal</h4>
                    <p class="text-black text-sm">Kelola jadwal pelajaran (akan datang)</p>
                </a>
