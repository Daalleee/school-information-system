        ...
        <div class="relative bg-gradient-to-br bg-yellow-400 text-white overflow-hidden">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="text-xl text-black max-w-3xl mx-auto">Ikuti perkembangan terbaru, kegiatan, dan
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row gap-4 items-center">
                <div class="flex-1 w-full">
                    <div class="relative">
                        <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-black"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex gap-2 flex-wrap">
                    ...
                    <button
                        class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Akademik</button>
                    <button
                        class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Prestasi</button>
                    <button
                        class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Kegiatan</button>
                    <button
                        class="px-5 py-2 bg-white text-black rounded-full text-sm font-medium hover:bg-black transition">Pengumuman</button>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($berita ?? [] as $item)
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                        <div class="h-48 bg-yellow-400 flex items-center justify-center relative cursor-pointer"
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="text-lg font-bold text-black mb-2">{{ $item->judul }}</h3>
                            <p class="text-black mb-4 text-sm">{{ Str::limit(strip_tags($item->isi), 120) }}</p>
                ...
                @empty
                    <div class="col-span-3 text-center py-12">
                        <p class="text-black">Belum ada berita</p>
                    </div>
                @endforelse
            </div>
