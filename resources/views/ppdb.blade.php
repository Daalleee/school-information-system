...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="/ppdb" class="text-blue-600 font-medium">PPDB</a>
    ...
    <section class="pt-16">
        <div
            class="relative bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-900 text-white overflow-hidden">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    <div
                        class="inline-block bg-yellow-400 text-indigo-900 px-4 py-2 rounded-full text-sm font-bold mb-6">
                        PENDAFTARAN DIBUKA</div>
                    <h1 class="text-5xl md:text-6xl font-bold mb-6">PPDB 2026/2027</h1>
                    <p class="text-xl text-indigo-100 max-w-3xl mx-auto">Penerimaan Peserta Didik Baru SMAK
                        Syuradikara. Bergabunglah menjadi bagian dari "Pencipta Pahlawan Utama"</p>
                    <div class="flex flex-wrap gap-4 justify-center mt-8">
                        <a href="#form-pendaftaran"
                            class="inline-block bg-yellow-400 text-indigo-900 font-bold py-3 px-8 rounded-lg hover:bg-yellow-300 transition">Daftar
                            Sekarang</a>
                        <a href="#alur"
    ...
    <section class="py-12 bg-white -mt-8 relative z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-3 gap-6">
                <div
                    class="bg-gradient-to-br from-indigo-50 to-white rounded-xl p-6 border border-indigo-100 text-center">
                    <div class="text-3xl font-bold text-indigo-600 mb-1">1 Mar - 30 Jun 2026</div>
                    <div class="text-gray-600">Periode Pendaftaran</div>
                </div>
                <div
                    class="bg-gradient-to-br from-green-50 to-white rounded-xl p-6 border border-green-100 text-center">
                    <div class="text-3xl font-bold text-green-600 mb-1">Rp 150.000</div>
                    <div class="text-gray-600">Biaya Pendaftaran</div>
                </div>
                <div
                    class="bg-gradient-to-br from-purple-50 to-white rounded-xl p-6 border border-purple-100 text-center">
                    <div class="text-3xl font-bold text-purple-600 mb-1">120 Siswa</div>
                    <div class="text-gray-600">Kuota Tersedia (4 Rombel)</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="alur" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">Ikuti langkah-langkah berikut untuk mendaftar
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    <div
                        class="w-16 h-16 bg-indigo-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                        1</div>
                    <h3 class="text-lg font-bold text-gray-800 mb-2">Daftar Online</h3>
                    <p class="text-gray-600 text-sm">Isi formulir pendaftaran online di bawah ini dengan data yang
                        lengkap dan benar</p>
                </div>
                <!-- Step 2 -->
                <div class="text-center">
                    <div
                        class="w-16 h-16 bg-indigo-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                        2</div>
                    <h3 class="text-lg font-bold text-gray-800 mb-2">Verifikasi Berkas</h3>
                    <p class="text-gray-600 text-sm">Serahkan berkas persyaratan ke panitia PPDB di sekolah untuk
                        diverifikasi</p>
                </div>
                <!-- Step 3 -->
                <div class="text-center">
                    ...
                    <p class="text-gray-600 text-sm">Ikuti tes seleksi akademik dan wawancara sesuai jadwal yang
                        ditentukan</p>
                </div>
                <!-- Step 4 -->
                <div class="text-center">
                    <div
                        class="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                        4</div>
                    <h3 class="text-lg font-bold text-gray-800 mb-2">Diterima & Daftar Ulang</h3>
                    <p class="text-gray-600 text-sm">Jika diterima, lakukan daftar ulang dan selamat menjadi bagian
                        Syuradikara!</p>
                </div>
            </div>
            ...
            <div class="mt-16 bg-white rounded-2xl shadow-lg p-8">
                <h3 class="text-2xl font-bold text-gray-800 mb-6 text-center">Persyaratan Pendaftaran</h3>
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="flex items-start"><svg class="w-6 h-6 text-indigo-600 mr-3 mt-0.5 flex-shrink-0"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                        </svg><span class="text-gray-700">Lulus SMP/MTs atau sederajat</span></div>
                    <div class="flex items-start"><svg class="w-6 h-6 text-indigo-600 mr-3 mt-0.5 flex-shrink-0"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                        </svg><span class="text-gray-700">Berusia maksimal 15 tahun</span></div>
                    <div class="flex items-start"><svg class="w-6 h-6 text-indigo-600 mr-3 mt-0.5 flex-shrink-0"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                        </svg><span class="text-gray-700">Fotokopi Ijazah/SKHUN yang dilegalisir</span></div>
                    <div class="flex items-start"><svg class="w-6 h-6 text-indigo-600 mr-3 mt-0.5 flex-shrink-0"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                        </svg><span class="text-gray-700">Fotokopi Akta Kelahiran</span></div>
                    <div class="flex items-start"><svg class="w-6 h-6 text-indigo-600 mr-3 mt-0.5 flex-shrink-0"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                        </svg><span class="text-gray-700">Fotokopi Kartu Keluarga</span></div>
                    <div class="flex items-start"><svg class="w-6 h-6 text-indigo-600 mr-3 mt-0.5 flex-shrink-0"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                        </svg><span class="text-gray-700">Pas foto 3x4 sebanyak 4 lembar</span></div>
                    <div class="flex items-start"><svg class="w-6 h-6 text-indigo-600 mr-3 mt-0.5 flex-shrink-0"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                        </svg><span class="text-gray-700">Surat Keterangan Sehat</span></div>
                    <div class="flex items-start"><svg class="w-6 h-6 text-indigo-600 mr-3 mt-0.5 flex-shrink-0"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                        </svg><span class="text-gray-700">Surat Keterangan Kelakuan Baik</span></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="form-pendaftaran" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">Isi data diri dengan lengkap dan benar</p>
            </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100">
                    <form class="space-y-6">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">No. HP / WhatsApp <span
                                        class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">No. HP Orang Tua / Wali</label>
                        ...
                        <div class="flex items-start">
                            ...
                            <label class="ml-2 text-sm text-gray-700">Saya menyatakan bahwa data yang saya isi adalah
                                benar dan saya bersedia mengikuti seluruh proses seleksi PPDB SMAK Syuradikara.</label>
                        </div>

                        <button type="submit"
                            class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200 text-lg">Kirim
                            Pendaftaran</button>
                    </form>
                </div>
            </div>
    ...
    <section class="py-20 bg-indigo-600 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-indigo-100 text-lg">Hubungi kami jika ada pertanyaan seputar pendaftaran</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div class="text-center">
                    ...
                    <p class="text-indigo-200">(0381) 21648</p>
                </div>
                <div class="text-center">
                    <div
                        class="w-14 h-14 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-indigo-200">0812-3456-7890</p>
                </div>
                <div class="text-center">
                    <div
                        class="w-14 h-14 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-indigo-200">ppdb@syuradikara.sch.id</p>
                </div>
            </div>
        </div>
    </section>
