        ...
        <div
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="text-xl text-yellow-100 max-w-3xl mx-auto">Penerimaan Peserta Didik Baru SMAK
    ...
    <section class="py-12 bg-white -mt-8 relative z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-3 gap-6">
                <div
                    class="bg-gradient-to-br from-yellow-50 to-white rounded-xl p-6 border border-yellow-200 text-center">
    ...
    <section class="py-20 bg-yellow-400 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-yellow-100 text-lg">Hubungi kami jika ada pertanyaan seputar pendaftaran</p>
            </div>
